            ...
            if mode == "on":
                ...
                if event.raw_text and event.type == "User" and not event.message.author_object_guid == admin.user.user_guid:
                    ...
                    if event.raw_text == "/start":
                        try:
                            await client.send_message(event.object_guid,file_inline="bot.png",type=methods.messages.Image,message=f"""
...
""")
                        ...
                        await client.send_message(event.object_guid,file_inline="start.jpg",type=methods.messages.Image,message=f"""
